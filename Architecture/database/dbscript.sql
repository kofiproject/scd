...
ALTER TABLE SCD.CREDIT_ITEM
 ADD UNIQUE (ACCOUNT_ID);

ALTER TABLE SCD.CREDIT_REQUEST
 ADD UNIQUE (ACCOUNT_ID);
...
ALTER TABLE SCD.CREDIT
 ADD (MAX_SUM_PERCENT  NUMBER(10,3)                 DEFAULT 0                     NOT NULL);

ALTER TABLE SCD.CREDIT_REQUEST
 ADD (LOCKED_BY_EMPLOYEE_ID  NUMBER(38));

ALTER TABLE SCD.CREDIT_REQUEST
 ADD FOREIGN KEY (LOCKED_BY_EMPLOYEE_ID) 
 REFERENCES SCD.EMPLOYEE (EMPLOYEE_ID);
