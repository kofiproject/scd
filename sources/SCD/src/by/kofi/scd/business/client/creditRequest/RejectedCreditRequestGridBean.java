 ...
 */
@Service
public class RejectedCreditRequestGridBean extends AbstractGridBusinessBean {

    private static final Logger LOGGER = Logger.getLogger(RejectedCreditRequestGridBean.class);
    ...
    public List<CreditRequestResultRow> executeSearch() throws SCDBusinessException {
        ...
        try {
            List<CreditRequest> creditRequests = creditRequestDataService.getCreditRequests(clientId, CreditRequestStateEnum.REJECTED);
