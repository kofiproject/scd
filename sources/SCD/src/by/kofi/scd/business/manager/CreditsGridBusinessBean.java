 ...
 */
@Service
public class CreditsGridBusinessBean extends AbstractGridBusinessBean {

    private static final Logger LOGGER = Logger.getLogger(CreditsGridBusinessBean.class);
    ...
    public List<CreditItemResultRow> executeSearch() throws SCDBusinessException {
        try {
            List<CreditItem> creditItems = clientDataService.getCreditItems();
