 ...
 */
@Service
public class ExpertConfirmedCreditRequestGridBean extends AbstractGridBusinessBean {

    private static final Logger LOGGER = Logger.getLogger(ExpertConfirmedCreditRequestGridBean.class);
    ...
    public List<CreditRequestResultRow> executeSearch() throws SCDBusinessException {
        ...
        try {
            List<CreditRequest> creditRequests = creditRequestDataService.getCreditRequestsByEmployee(employeeId, CreditRequestStateEnum.CONFIRMED);
